module Sass::Script::Functions
  ...
  private
    ...
    def image_dimensions(image_file)
      options[:preyassets] ||= {}
      options[:preyassets][:image_dimensions] ||= {}
      options[:preyassets][:image_dimensions][image_file.value] = ImageProperties.new(image_path_for_size(image_file.value)).size
    end
    ...
    def real_path(image_file)
      ...
      #end
      File.join(Rails.root , "app/assets/images/" , image_file )
